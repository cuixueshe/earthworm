    ...
    <section class="flex md:flex-row md:justify-between justify-center flex-col py-8">
      <div class="w-1/2">
        <div class="flex mb-12">
          <img class="rounded-xl overflow-hidden mr-2" src="https://sdfsdf.dev/160x160.jpg,c683d7,ffffff" alt="earth-worm-logo">
        ...
        <div class="mb-12 leading-loose text-3xl opacity-60 items-center">
          <!-- <p>This is the description of Earthworm</p> -->
        ...
        <!-- <NuxtLink to="/courses/111"> gogogo </NuxtLink> -->
      </div>
