<template>
  <div>
    ...
    <section>
      <h2>1. 个人信息的收集</h2>
      <p>
        用户注册时，我们将收集用户的个人信息，包括但不限于姓名、电子邮件地址、电话号码等。
      </p>
    ...
    <section>
      <h2>2. 个人信息的使用</h2>
      <p>
        我们将使用收集到的个人信息来提供用户注册服务，并用于改进我们的服务。
      </p>
    ...
    <section>
      <h2>3. 个人信息的存储</h2>
      <p>
        我们将采取合理的安全措施来保护用户个人信息，防止未经授权的访问、使用或披露。
      </p>
    ...
    <section>
      <h2>4. 个人信息的共享</h2>
      <p>
        我们不会将用户的个人信息共享给第三方，除非得到用户的明确同意或法律法规的要求。
      </p>
    ...
    <section>
      <h2>6. 隐私政策的更新</h2>
      <p>
        我们可能会随时更新本隐私政策，以反映我们的服务变化或遵守新的法律法规。
      </p>
      <p>更新后的隐私政策一旦发布即生效。</p>
    </section>
    ...
    <section>
      ...
      <p>
        为确保产品正常运转，产品会在您的计算机或移动设备上存储名为 Cookie
        的小数据文件。Cookie 通常包含标识符、产品名称以及一些号码和字符。借助于
        Cookie，产品能够存储您的偏好或商品等数据，并用以判断注册用户是否已经登录，提升服务和产品质量及优化用户体验。
      </p>
      <p>
        产品出于不同的目的使用各种 Cookie，包括：严格必要型 Cookie、性能
        Cookie、营销 Cookie 和功能 Cookie。某些 Cookie
        可能由外部第三方提供，以向产品提供其它功能。产品不会将 Cookie
