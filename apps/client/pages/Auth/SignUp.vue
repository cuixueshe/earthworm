<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img class="mx-auto h-10 w-auto" src="/logo.png" alt="Your Logo" />
...
import CountryPhoneInput from "~/pages/Auth/CountryPhoneInput.vue"; // 确保路径正确
...
function updateCountryCode(code: string) {
  console.log('Updated country code:', code);
