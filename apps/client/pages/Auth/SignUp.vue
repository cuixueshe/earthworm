    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
                Has a account?
                <NuxtLink href="/auth/signin" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                    Sign in
                </NuxtLink>
            </p>
        </div>
...
const rules: FormRules = {
    ...
    confirmPassword: [
        ...
        { validator: validatePasswordSame, message: 'The two password inputs are inconsistent' }
    ]
}
