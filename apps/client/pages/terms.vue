<template>
  <div>
    ...
    <section>
      ...
      <p>
        用户对其账户下的所有行为负责，应妥善保管账户信息和密码，防止未授权使用。
      </p>
    </section>
    ...
    <section>
      <h2>3. 隐私政策</h2>
      <p>
        本服务尊重用户隐私，承诺不泄露用户的个人信息，除非得到用户的授权或根据法律法规的要求。
      </p>
      <p>
        本服务可能会收集用户信息以提供个性化服务，具体请参考隐私政策。 知识产权
      </p>
    </section>
    ...
    <section>
      <h2>4. 知识产权</h2>
      <p>
        本服务中的所有内容，包括但不限于文本、图片、音频、视频等，均受知识产权法律的保护。
      </p>
    ...
    <section>
      <h2>8. 法律适用与争议解决</h2>
      <p>
        本条款的解释、有效性和执行均适用服务提供方所在地的法律。
      </p>
      <p>如发生争议，双方应友好协商解决；协商不成的，任何一方可以向服务提供方所在地的人民法院提起诉讼。</p>
    </section>

    <section>
      <h2>9. 终止与服务提供方的关系</h2>
      <p>
        用户可随时终止使用本服务，本服务也可根据条款终止或限制用户的使用。
      </p>
