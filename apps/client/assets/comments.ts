...
const comments: Comment[] = [
    {
        ...
        link: "",
        comment:
            "This English learning application of conjunctions and sentences is so addictive that I want to play it every day!",
        chinese: "这款连词造句的英语学习应用真是太上瘾了，我每天都想玩儿！",
    },
    ...
    },
    {
        ...
        link: "",
        comment:
            "Now I have to browse this app every day, and I feel that my English is improving by leaps and bounds, interesting and full of sense of achievement.",
        chinese:
            "我现在每天都要刷这个应用，感觉自己的英语水平突飞猛进，有趣又富有成就感。",
    },
    {
        name: "yaolifeng0629",
        ...
        link: "",
        comment:
            "Such an interesting and fulfilling English learning application is really unstoppable. Awesome!",
        chinese: "如此有趣又有成就感的英语学习应用，真是让人欲罢不能，赞！",
    },
    {
        name: "hildxd",
    ...
    },
    {
        ...
        chinese:
            "真没想到学习英语可以这么有趣，这个连词造句的方式简直让我停不下来。",
    },
];
