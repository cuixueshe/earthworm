  ...
  >
    ...
    >
      ...
      <n-tabs
        ...
        type="line"
        :value="currentPeriod"
        :on-update:value="changePeriodValue"
      >
        <n-tab-pane
          v-for="item in RankPeriodList"
          :key="item.value"
          :name="item.value"
          :tab="item.label"
        >
          ...
          <div
            v-else
            class="flex flex-col gap-2 py-3 min-h-52"
          >
            <div
            ...
            <div
              class="flex items-center justify-between w-[350px] px-4 text-[14px] dark:text-white text-black mt-auto"
            >
              <div class="flex items-center gap-4">
                <div
                  class="w-[26px] h-[26px] flex items-center justify-center text-[#f26419]"
