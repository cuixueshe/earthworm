<template>
  ...
  >
    <div class="mx-auto text-center my-5">
      <h2
        class="text-3xl lg:text-4xl xl:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-gray-200 dark:from-purple-600 dark:to-gray-100"
      >
        让你上瘾的英语学习工具
      </h2>
    ...
    >
      ...
      <a
        ...
        target="_blank"
        class="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full px-6 duration-500 cursor-pointer"
      >
        <div
          class="relative inline-flex -translate-x-0 items-center transition group-hover:-translate-x-6"
        >
          <div
            class="absolute translate-x-0 opacity-100 transition group-hover:-translate-x-6 group-hover:opacity-0 text-purple-600"
          >
            <svg
              width="15"
              height="15"
          ...
          <span
            class="pl-6 font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-gray-300"
            >Star us on GitHub</span
          >
          <div
            class="absolute right-0 translate-x-12 opacity-0 transition group-hover:translate-x-6 group-hover:opacity-100 text-purple-400"
          >
            <svg
              width="15"
              height="15"
